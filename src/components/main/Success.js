  ...
  const AnimatedComponent = () => {
    ...
    useEffect(() => {
      const handleScroll = () => {
        ...
        const element = document.getElementById('1'); // Replace 'your-component-id' with the actual ID of your component
        if (element) {
          const elementTop = element.offsetTop;
          const windowHeight = window.innerHeight;
          const scrollThreshold = elementTop - windowHeight;
  
          setShouldAnimate(position >= scrollThreshold);
        }
      };
  ...
  return (
    <>
      ...
      <Container maxWidth="lg" sx={{ width: "100vw", height: 'auto' }}>
        <Box sx={{}}>
          {/* <section class="case-cards ai-section js-animation js-animation-start-80 case-cards--white section--indents-large" > */}
          <div className="ai-container" >
            <div className="case-cards__text-content" >

              <h2 className="case-cards__title hfs1" >Success Stories</h2>

              <div className="case-cards__text">
                <p className="pfs2" >Unique business situations administered by personalized technology suite solutions are why industry and market leaders trust Avenga with their digital endeavors. A pragmatic and customer-centered approach is behind each of these success stories.</p>
              </div>

            </div>
           
            <div className="case-cards__grid-items js-case-cards-slider " id='1'>
              {` ${shouldAnimate ? 'animate' : '  '}`}
             
              <article className="case-card case-card--azure case-card--azuree " style={{ width: '100%', display: "inline-block" }} >
              ...
              <article className="case-card case-card--blue case-card--bluee">
                <div className="case-card__inner" data-popup-item="">
                  <div className="case-card__video-container">
